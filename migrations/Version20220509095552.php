 ...
 */
final class Version20220509095552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BCE3F798A545015 ON sub_category');
        $this->addSql('ALTER TABLE sub_category CHANGE id_category_id category_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sub_category CHANGE category_id id_category_id INT NOT NULL');
